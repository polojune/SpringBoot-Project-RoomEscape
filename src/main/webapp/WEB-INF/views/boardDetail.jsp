...
<%@ include file="include/nav.jsp"%>
     ...
     <!--  -->  <script>
            ...
            <div class="comments_box">
	          ...
	          <div class="comment_info" style="text-align: left">
					...
					<div class="comment_content" style="text-align: left;padding-left:40; margin-bottom: 10" >
						<span>${commentRespDto.content}<span>
						</span></span>
					</div>
					<div class="comment_write_datetime" style="text-align: left" >
