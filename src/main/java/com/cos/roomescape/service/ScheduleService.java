...
public class ScheduleService {
	...
	public List<String> 특정일시간표가져오기(int themeId, String datetime_string) {
		...
		List<String> scheduleList = scheduleRepository.findByThemeIdAndDate(themeId, date.toString());
